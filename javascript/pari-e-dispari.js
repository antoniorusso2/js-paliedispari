...
const oddOrEven = prompt('Scegli \'pari o dispari\'').toLowerCase();//string --- 'pari' ||'dispari'
console.log(oddOrEven);

  //validazione pari o dispari
    //SE parola inserita !== da pari o dispari
...
console.log(typeof nUser, nUser)
...
//somma numeri
let sum = nCpu + nUser;
console.log(nUser, nCpu, sumOddOrEven);
...
let sumOddOrEven = isEven(sum);

//SE l'utente ha scelto peri o dispari e la somma e' uguale alla scelta dell'utente
if(oddOrEven === 'pari' && sumOddOrEven === true){
  console.log('hai vinto');
} else if (oddOrEven === 'dispari' && sumOddOrEven === false){
  console.log('hai vinto');
} else {
...
//dichiarare un vincitore
  //-SE la somma dei due numeri e' uguale al valore 'pari o dispari' scelto dall'utente allora l'utente ha vinto
  //-ALTRIMENTI ha perso
